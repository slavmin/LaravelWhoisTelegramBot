    ...
    */
    'bots' => [
        'uno' => [
            ...
            'commands' => [
                \App\Telegram\Bot\Commands\StartBotCommand::class,
                \App\Telegram\Bot\Commands\DomainListBotCommand::class,
                \App\Telegram\Bot\Commands\DomainWhoisBotCommand::class,
                \App\Telegram\Bot\Commands\DomainAddBotCommand::class,
                \App\Telegram\Bot\Commands\DomainWhoisUpdateBotCommand::class,
                \App\Telegram\Bot\Commands\DomainDeleteBotCommand::class,
...
//        ],
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may specify maximum string length of message.
    |
    */
    'max_length' => 4096,
